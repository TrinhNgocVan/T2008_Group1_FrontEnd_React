...
function HomePage(){
    document.title ="Group 1 | Trang chủ";
    return (
        <div className="card">
                        ...
                        <div className="item1 card card-body bg-teal-700 has-bg-image" >
                            <div className="media">
                                <div className="media-body">
                                    ...
                                    <div className="text-light"><span className="text-uppercase font-size-xs">Số dư tài khoản </span>
                                    </div>
                                    <div className="text-light"><span className="text-uppercase font-size-xs">Công nợ : <span id="customerActiveQuantity"></span></span></div>
                                    <div className="text-light"><span className="text-uppercase font-size-xs">Công nợ  : <span
                        ...
                        <div className="item1 card card-body bg-teal-400 has-bg-image" >
                            <div className="media">
                                <div className="media-body">
                                    ...
                                    <div className="text-light"><span className="text-uppercase font-size-xs">Tổng số nhân viên  </span>
                                    </div>
